...
namespace NextPark.Mobile.Services.Data
{
    public class EventDataService : IEventDataService
    {
        ...
        public async Task<ApiResponse<EventModel>> EditEventsAsync(int id, EventModel eventModel)
        {
            var url = ApiSettings.EventsEndPoint;
        ...
        public async Task<ApiResponse<List<EventModel>>> EditSerieEventsAsync(EventModel eventModel)
        {
        ...
        public async Task<ApiResponse<EventModel>> DeleteEventsAsync(int id)
        {
            var url = ApiSettings.EventsEndPoint;
        ...
        public async Task<ApiResponse<List<EventModel>>> DeleteSerieEventsAsync(int id)
        {
