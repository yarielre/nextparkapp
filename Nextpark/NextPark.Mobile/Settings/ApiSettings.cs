...
namespace NextPark.Mobile.Core.Settings
{
    ...
    {
        public static string BaseUrl = "http://vps519741.ovh.net:5043"; // "http://192.168.0.10/Inside.Web"; // "http://inside-web.azurewebsites.net";// "http://192.168.1.53/Inside.Web";//"http://149.202.41.48:5041";  //"http://10.0.2.2:5041"; //"http://149.202.41.48:5041";
